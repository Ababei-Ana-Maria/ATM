...
<head id="Head1"
  ...
  <div style="height: 50px; width: auto"; 
      ...
      <asp:Button ID="LogOut" runat="server" OnClick="LogOut_Click" Text="Log Out" OnClientClick="SetTarget();"/>
        </div>
    ...
    <div style="height: 50px; margin-top: 46px">
        ...
        <asp:Button ID="home" runat="server" OnClick="home_Click" Text="Home" OnClientClick="SetTargets();" />
